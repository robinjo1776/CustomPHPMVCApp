...
if (isset($uid)) {
    ...
    $sql = "SELECT prov.*, c_usr.name as cname, c_usr.sname as csname, 
...
?>
        ...
        <div class="container-fluid-lg">
            ...
            <div class="dt-list-item-block">
                <div class="" style="text-align: right; margin-bottom:10px;">
                    <a href="javascript:void(0);" class="btn btn-success open-province-btn"><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
                </div>
                <table class="table table-hover item-list-dataTable">
                    <thead>
                        <tr>
                            ...
                            <th onclick="sortTable(2)">English Name</th>
                            <th onclick="sortTable(3)">French Name</th>
                            <th onclick="sortTable(4)">Created By</th>
                            <th onclick="sortTable(5)">Created At</th>
                            <th onclick="sortTable(6)">Updated By</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a title="<?php echo $row["english"]; ?>" class="btn-edit-sale" href="province/<?php echo $row["id"]; ?>">
                                        <?php echo $row["english"]; ?>
                                    </a>
                                </td>
                                <td><?php echo (isset($row["french"]) && !empty($row["french"])) ? $row["french"] : ''; ?></td>
                                ...
                                <td class="text-nowrap table-action-col">
                                    <div class="btn-group table-btn-group order-table-action-container">
                                        <a title="Edit" class="btn-edit-sale" href="province/<?php echo $row["id"]; ?>">
                                            <i class="fa-sharp fa-solid fa-pencil"></i>
                                        </a>
                                        <a title="Delete" class="btn-delete-sale delete" href="province/delete/<?php echo $row["id"]; ?>">
            ...
            <div class="slide-order-form-block">
                <?php require_once(VIEW_PATH . 'settings/province/province-form.php');
                ?>
            </div>
    ...
    <script src="<?php echo Helper::fullbaseUrl(); ?>assets/js/province.js"></script>
