$(document).ready(function () {
  ...
  $(".item-list-dataTable").on("click", ".btn-edit-sale", function (e) {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $(".slider-form-header").text("Update City");
      },
  ...
  $(".slide-form-submit").on("submit", function (e) {
    ...
    if ($("#slide_new_form").valid()) {
      ...
      url = API_BASE_URL + "city/create";
      let city_id = $("#city_id").val();
      if (city_id) {
        url = API_BASE_URL + "city/update";
      }
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.status == true) {
            ...
            listDataTable.draw();
            location.reload();
          } else if (response.status == "city_name") {
            let alertError = "";
            alertError +=
