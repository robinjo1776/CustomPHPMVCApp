<table id="invoiceTable" style="width: 100%; margin-bottom: 120px;">
    ...
    <tr>
        <td colspan="2" style="padding-bottom: 10px;">
            <table border="0" style="width: 100%; margin-top: 35px; border-collapse: collapse; vertical-align: top;">
                <thead>
                    <tr style="background-color:  #ccd1d8;; ">
                        <td style="padding: 8px; text-align: left;">DESCRIPTION</td>
                        <td style="padding: 8px; text-align: right;">PIECES</td>
                        <td style="padding: 8px; text-align: right;">BOXES</td>
                        <td style="text-align: right; padding: 8px;">WEIGHT (kg)</td>
                        <td style="text-align: right; padding: 8px;">RATE ($/kg)</td>
                        <td style="padding: 8px; text-align: right;">AMOUNT</td>
                    </tr>
                </thead>
                <thead class="tewts">
                    <tr style="background-color: #FFF; display: none; opacity: 0;">
                ...
                <tbody>
                    ...
                    ?>
                            ...
                            <?php if ((isset($orderItemsArr[$rkey + 1]) && $row["cat_code"] != $orderItemsArr[$rkey + 1]["cat_code"]) || $rkey == count($orderItemsArr) - 1) { ?>
                                <tr>
                                    <td style="padding:8px;"><?php echo $row["cat_des"]; ?></td>
                                    <td style="text-align: right; padding:8px;"><?php echo $itemTotalQty; ?></td>
                                    <td style="text-align: right; padding:8px;"><?php echo $itemTotalBox; ?></td>
                                    <td style="text-align: right; padding:8px;"><?php echo $itemTotalWeight; ?></td>
                                    <td style="text-align: right; padding:8px;">$<?php echo number_format($tp, 2); ?></td>
                                    <td style="text-align: right; padding:8px;">$<?php echo number_format($itemSubTotal, 2); ?></td>
                                </tr>
                            <?php } ?>
                        <?php
                        }
                        ...
                        <tr style="border-top: 2px dotted #b9bec4;  border-bottom: 2px dotted #b9bec4; ">
                            <td style="text-align: right; padding:8px;"><strong>Totals:</strong></td>
                            <td style="text-align: right; padding:8px;"><?php echo $totalQty; ?></td>
                            <td style="text-align: right; padding:8px;"><?php echo $totalBox; ?></td>
                            <td style="text-align: right; padding:8px;"><?php echo $totalWeight; ?></td>
                            <td style="text-align: right; padding:8px;">&nbsp;</td>
                            <td style="text-align: right; padding:8px;">$<?php echo number_format($subTotal, 2); ?></td>
                        </tr>
                    <?php
                    }
                            ...
                            <table style="width: 100%;">
                                <tr style="vertical-align: top; width: 100%;">
                                    <td style="padding-bottom: 10px; width: 50%; vertical-align: top; color: #8c8f95; font-size: 14px; text-align: left;">
                                        <?php echo $orderDetails["inv_label"]; ?>
                                    </td>
                                    <td style="padding-bottom: 10px;  width: 50%; vertical-align: top; color: #000; font-size: 14px; text-align: right;">
                                        <?php echo (isset($orderDetails["inv_val"]) && !empty($orderDetails["inv_val"]) && $orderDetails["inv_val"] != 0.00) ? "$" . $orderDetails["inv_val"] : ""; ?>
                                    </td>
                                </tr>
                                <tr style="vertical-align: top; width: 100%;">
