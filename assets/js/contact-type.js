$(document).ready(function () {
  ...
  $(".item-list-dataTable").on("click", ".btn-edit-sale", function (e) {
    ...
    $(".open-contact-type-btn").trigger("click");
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $("#status_cont_type").val(response.data.status_cont_type);
        $("#contact_type_id").val(response.data.id);

        $("#savefrmBtn").text("Update");
        $(".slider-form-header").text("Update Contact Type");
      },
  ...
  $(".slide-form-submit").on("submit", function (e) {
    ...
    if ($("#slide_new_form").valid()) {
      ...
      url = API_BASE_URL + "contact-type/create";
      let contact_type_id = $("#contact_type_id").val();
      if (contact_type_id) {
        url = API_BASE_URL + "contact-type/update";
      }
