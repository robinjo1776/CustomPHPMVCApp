$(document).ready(function () {
  ...
  $(".item-list-dataTable").on("click", ".btn-edit-sale", function (e) {
    ...
    $(".open-shipvia-btn").trigger("click");
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $("#shipvia_id").val(response.data.id);

        $("#savefrmBtn").text("Update");
        $(".slider-form-header").text("Update Shipvia");
      },
  ...
  $(".slide-form-submit").on("submit", function (e) {
    ...
    if ($("#slide_new_form").valid()) {
      ...
      url = API_BASE_URL + "shipvia/create";
      let shipvia_id = $("#shipvia_id").val();
      if (shipvia_id) {
        url = API_BASE_URL + "shipvia/update";
      }
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.status == true) {
            ...
            listDataTable.draw();
            location.reload();
          } else if (response.status == "shipvia") {
            let alertError = "";
            alertError +=
