$(document).ready(function () {
  ...
  $(".item-list-dataTable").on("click", ".btn-edit-sale", function (e) {
    ...
    $(".open-contact-method-btn").trigger("click");
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $("#status_mcontact").val(response.data.status_mcontact);
        $("#contact_method_id").val(response.data.id);

        $("#savefrmBtn").text("Update");
        $(".slider-form-header").text("Update Contact Method");
      },
  ...
  $(".slide-form-submit").on("submit", function (e) {
    ...
    if ($("#slide_new_form").valid()) {
      ...
      url = API_BASE_URL + "contact-method/create";
      let contact_method_id = $("#contact_method_id").val();
      if (contact_method_id) {
        url = API_BASE_URL + "contact-method/update";
      }
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.status == true) {
            ...
            // listDataTable.draw();
            location.reload();
          } else if (response.status == "method") {
            let alertError = "";
            alertError +=
