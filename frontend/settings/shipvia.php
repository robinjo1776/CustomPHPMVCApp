...
if (isset($uid)) {
    ...
    $sql = "SELECT shv.*, c_usr.name as cname, c_usr.sname as csname, 
        ...
        ORDER BY shv.id DESC";
    $result = mysqli_query($conn, $sql);

    $settings_menu_active = "active";
    $shipvia_menu_active = "active";
    $pageTitle = "Shipvia List";
?>
        ...
        <div class="container-fluid-lg">
            ...
            <div class="dt-list-item-block">
                <div class="" style="text-align: right; margin-bottom:10px;">
                    <a href="javascript:void(0);" class="btn btn-success open-shipvia-btn"><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
                </div>
                <table class="table table-hover item-list-dataTable">
                    <thead>
                        <tr>
                            <th onclick="sortTable(0)">Id</th>
                            <th onclick="sortTable(1)">Shipvia</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a title="<?php echo $row["shipvia"]; ?>" class="btn-edit-sale" href="shipvia/<?php echo $row["id"]; ?>">
                                ...
                                <td class="text-nowrap table-action-col">
                                    <div class="btn-group table-btn-group order-table-action-container">
                                        <a title="Edit" class="btn-edit-sale" href="shipvia/<?php echo $row["id"]; ?>">
                                            <i class="fa-sharp fa-solid fa-pencil"></i>
                                        </a>
                                        <a title="Delete" class="btn-delete-sale delete" href="shipvia/delete/<?php echo $row["id"]; ?>">
            ...
            <div class="slide-order-form-block">
                <?php require_once(VIEW_PATH . 'settings/shipvia/shipvia-form.php');
                ?>
            </div>
    ...
    <script src="<?php echo Helper::fullbaseUrl(); ?>assets/js/shipvia.js"></script>
