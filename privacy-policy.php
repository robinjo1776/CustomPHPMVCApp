    ...
    <div class="container-fluid-lg">
        ...
        <div class="content-container">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <b>Last updated:</b> November 14, 2023<br><br>
                        ...
                        <ul>
                            ...
                            <li>Application refers to Winter's Turkeys, the software program provided by the Company.</li>
                            <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to 970805 AB Ltd o/a Winter's Turkeys, 272039 Twp Rd 224 Rocky View County AB T1X 2B2.</li>
                        ...
                        <ul>
                            <li>Service Providers: We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to contact You.</li>
                        ...
                        <p> You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this</p>
                        <br /><br />
                    </div>
                </div>
            </div>
