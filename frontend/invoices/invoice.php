            ...
            <div class="container">
                <div class="row">
                    <div id="printBtnBlock" class="col-md-12" style="margin-top: 90px; text-align: right;">
                        ...
                        <a target="_blank" href="<?php echo Helper::fullbaseUrl(); ?>frontend/invoices/invoice-pdf.php?invoiceno=<?php echo $invoiceno; ?>" class="btn btn-info" id="saveAsPdfButton">Save as PDF <i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
                    </div>
                    <div class="col-md-12" style="margin-top: 20px;">
                        <?php require_once(BASEPATH . 'frontend/invoices/invoice-content.php'); ?>
                    </div>
                </div>
            </div>
