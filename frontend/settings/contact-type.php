...
if (isset($uid)) {
    ...
    $sql = "SELECT cont.*, c_usr.name as cname, c_usr.sname as csname, 
    ...
    $contact_type_menu_active = "active";
    $pageTitle = "Contact Type List";
?>
        ...
        <div class="container-fluid-lg">
            ...
            <div class="dt-list-item-block">
                <div class="" style="text-align: right; margin-bottom:10px;">
                    <a href="javascript:void(0);" class="btn btn-success open-contact-type-btn"><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
                </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a title="<?php echo $row["description"]; ?>" class="btn-edit-sale" href="contact-type/<?php echo $row["id"]; ?>">
                                ...
                                <td class="text-nowrap table-action-col">
                                    <div class="btn-group table-btn-group order-table-action-container">
                                        <a title="Edit" class="btn-edit-sale" href="contact-type/<?php echo $row["id"]; ?>">
                                            <i class="fa-sharp fa-solid fa-pencil"></i>
                                        </a>
                                        <a title="Delete" class="btn-delete-sale delete" href="contact-type/delete/<?php echo $row["id"]; ?>">
            ...
            <div class="slide-order-form-block">
                <?php require_once(VIEW_PATH . 'settings/contact-type/contact-type-form.php');
                ?>
            </div>
    ...
    <script src="<?php echo Helper::fullbaseUrl(); ?>assets/js/contact-type.js"></script>
