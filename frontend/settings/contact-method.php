...
if (isset($uid)) {
    ...
    $sql = "SELECT conm.*, c_usr.name as cname, c_usr.sname as csname, 
        ...
        ORDER BY conm.id DESC";
    $result = mysqli_query($conn, $sql);

    $settings_menu_active = "active";
    $contact_method_menu_active = "active";
    $pageTitle = "Contact Method List";
?>
        ...
        <div class="container-fluid-lg">
            ...
            <div class="dt-list-item-block">
                <div class="" style="text-align: right; margin-bottom:10px;">
                    <a href="javascript:void(0);" class="btn btn-success open-contact-method-btn"><i class="fa fa-plus" aria-hidden="true"></i> Add</a>
                </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a title="<?php echo $row["method"]; ?>" class="btn-edit-sale" href="contact-method/<?php echo $row["id"]; ?>">
                                        <?php echo $row["method"]; ?>
                                    </a>
                                </td>
                                ...
                                <td class="text-nowrap table-action-col">
                                    <div class="btn-group table-btn-group order-table-action-container">
                                        <a title="Edit" class="btn-edit-sale" href="contact-method/<?php echo $row["id"]; ?>">
                                            <i class="fa-sharp fa-solid fa-pencil"></i>
                                        </a>
                                        <a title="Delete" class="btn-delete-sale delete" href="contact-method/delete/<?php echo $row["id"]; ?>">
            ...
            <div class="slide-order-form-block">
                <?php require_once(VIEW_PATH . 'settings/contact-method/contact-method-form.php');
                ?>
            </div>
    ...
    <script src="<?php echo Helper::fullbaseUrl(); ?>assets/js/contact-method.js"></script>
