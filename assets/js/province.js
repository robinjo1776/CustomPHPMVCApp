$(document).ready(function () {
  ...
  $(".item-list-dataTable").on("click", ".btn-edit-sale", function (e) {
    ...
    $(".open-province-btn").trigger("click");
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $("#french").val(response.data.french);
        ...
        $("#status_prov").val(response.data.status_prov);
        $("#province_id").val(response.data.id);

        $("#savefrmBtn").text("Update");
        $(".slider-form-header").text("Update Province");
      },
  ...
  $(".slide-form-submit").on("submit", function (e) {
    ...
    if ($("#slide_new_form").valid()) {
      ...
      url = API_BASE_URL + "province/create";
      let province_id = $("#province_id").val();
      if (province_id) {
        url = API_BASE_URL + "province/update";
      }
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.status == true) {
            ...
            listDataTable.draw();
            location.reload();
          } else if (response.status == "shortname") {
            let alertError = "";
            alertError +=
