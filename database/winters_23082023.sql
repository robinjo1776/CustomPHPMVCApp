...
INSERT INTO `cities` (`id`, `city`, `province`, `status_city`) VALUES
(1, 'Calgary', 'Alberta', 0),
(2, 'Edmonton', 'Alberta', 0);
...
CREATE TABLE `contact_methods` (
  ...
  `mod_date` varchar(250) NOT NULL,
  `mod_time` varchar(250) NOT NULL,
  `status_cont_method` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `contact_methods` (`id`, `description`, `cr_date`, `cr_time`, `mod_date`, `mod_time`, `status_cont_method`) VALUES
(1, 'E-mail', '2023-08-14', '11:20:02pm', '', '', 0),
(2, 'Home Fax', '2023-08-14', '11:21:53pm', '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `cont_type`
--
...
CREATE TABLE `cont_type` (
  ...
  `mod_date` varchar(250) NOT NULL,
  `mod_time` varchar(250) NOT NULL,
  `status_cont_type` int(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `cont_type`
--

INSERT INTO `cont_type` (`id`, `description`, `cr_date`, `cr_time`, `mod_date`, `mod_time`, `status_cont_type`) VALUES
(1, 'Assisstant', '2023-08-14', '10:49:20pm', '', '', 0),
(2, 'Home', '2023-08-14', '10:50:34pm', '', '', 0),
(3, 'Business', '2023-08-14', '10:50:42pm', '', '', 0),
(4, 'Home Fax', '2023-08-14', '10:53:13pm', '', '', 0),
(5, 'E-mail', '2023-08-14', '11:11:40pm', '', '', 0);
...
INSERT INTO `cust_addresses` (`id`, `name`, `cust_type`, `created`, `modified`, `address1`, `address2`, `city`, `province`, `postal`, `status_cust_address`) VALUES
(21, 'Robin', '', '2023-08-15', '', '7 Edgewood Pl NW', 'geg', 'Calgary', 'Alberta', 'T3A 2T8', 0),
(22, 'Fred', 'Business', '2023-08-15', '', '64 ladner drive north york on', 'frwfrw', 'Toronto', 'Ontario', 'M2J 3Z7', 0),
(23, 'Hambantota', 'Home', '2023-08-15', '', '107 Castlebrook Dr NE', 'mhff', 'Calgary', 'Alberta', 'T3J 1S8', 0),
(24, 'Robin Joseph', 'Home', '2023-08-15', '', '1195 Gateway road', 'cscs', 'Calgary', 'Ontario', 'K2C2X1', 0),
(25, 'Robin Joseph', 'Business', '2023-08-15', '', '107 Castlebrook Dr NE', 'utkt', 'Calgary', 'Alberta', 'T3J 1S8', 0),
(26, 'Robin Joseph', 'Business', '2023-08-15', '', '107 Castlebrook Dr NE', 'yrjr', 'Calgary', 'Alberta', 'T3J 1S8', 0),
(27, 'Robin Joseph', 'Business', '2023-08-15', '', '7 Egdewood Pl NW Calgary AB T3A2T8', 'u', 'Calgary', 'Alberta', 'T3A 2T8', 0);
...
INSERT INTO `cust_phones` (`id`, `cust_name`, `cust_type`, `type`, `name`, `method`, `detail`, `mod_date`, `mod_time`, `status_cust_phone`) VALUES
(70, 'Hambantota', 'Home', 'Friend', 'Flintstones', 'telephone', 'yhnyn', '', '', 0),
(71, 'Hugo', 'Home', 'Business', 'Ravindra', 'E-mail', 'wrgw', '', '', 0),
(72, 'Fred', 'Business', 'Home Fax', 'Maharjan', 'Home Fax', 'hyrh yrhr', '', '', 0);
...
INSERT INTO `orders` (`id`, `orderno`, `invoiceno`, `customer`, `address1`, `address2`, `orderedby`, `terms`, `shipvia`, `orderdate`, `invoicedate`, `reqdate`, `shipdate`, `istatus`, `status_ord`) VALUES
...
INSERT INTO `shipvia` (`id`, `guid`, `shipvia`, `mod_date`, `mod_time`, `status_shipvia`) VALUES
(1, 'EAFAFA97966', '', '', '', 0),
(2, 'DDB6978606DDV', '', '', '', 0),
(3, 'FRIJIJ969960C', 'Louvic', '', '', 0),
(4, 'DED80870GET', 'Purolator', '', '', 0);
...
INSERT INTO `units` (`id`, `short_name`, `description`, `status_unit`) VALUES
(1, 'box', 'box', 0),
(2, 'ea', 'each', 0);
...
--
-- AUTO_INCREMENT for table `cont_type`
--
ALTER TABLE `cont_type`
...
--
-- AUTO_INCREMENT for table `shipvia`
--
ALTER TABLE `shipvia`
