                ...
                <tr>
                  ...
                  <td>
                    <?php if (isset($row["orderno"]) && !empty($row["orderno"])) { ?>
                      <a title="<?php echo $row["orderno"]; ?>" class="btn-edit-sale" href="order/<?php echo $orderno; ?>">
                  ...
                  <td align="center">
                    <?php if (isset($row["invoiceno"]) && !empty($row["invoiceno"])) { ?>
                      <a title="Invoice" class="btn-view-sale invoice" href="frontend/invoices/invoice.php?invoiceno=<?php echo $row["invoiceno"]; ?>" target="_blank">
                  ...
                  <td class="text-nowrap table-action-col">
                    <div class="btn-group table-btn-group order-table-action-container">
                      <?php if (isset($row["invoiceno"]) && !empty($row["invoiceno"])) { ?>
                        <a title="Invoice" class="btn-view-sale invoice" href="frontend/invoices/invoice.php?invoiceno=<?php echo $invoiceno; ?>" target="_blank">
                          <i class="fa fa-usd" aria-hidden="true"></i>
                        </a>
                      <?php } else { ?>
                        <a title="Invoice" class="btn-view-sale invoice invoice-generate" href="frontend/invoices/invoice-generate.php?orderno=<?php echo $orderno; ?>" target="_blank">
                          <i class="fa fa-usd" aria-hidden="true"></i>
                        </a>
                      <?php } ?>
                      <?php if (isset($row["invoiceno"]) && !empty($row["invoiceno"])) { ?>
                        <a title="Bill of Lading" class="btn-invoice" href="frontend/orders/BOL.php?invoiceno=<?php echo $invoiceno; ?>" target="_blank">
                          <i class="fa-solid fa-file-invoice bol"></i>
                        </a>
                      <?php } ?>
                      <?php if (isset($row["invoiceno"]) && !empty($row["invoiceno"])) { ?>
                        <a title="Shipping Label" class="shipping-label" href="frontend/shipping/shipping-label.php?invoiceno=<?php echo $invoiceno; ?>" target="_blank">
                          <i class="fa-solid fa-file-invoice"></i>
                        </a>
                      <?php } ?>
                      <?php if (isset($row["invoiceno"]) && !empty($row["invoiceno"])) { ?>
                        <a title="Pick Sheet" class="btn-view-sale pick-sheet" href="frontend/orders/pick-sheet.php?invoiceno=<?php echo $invoiceno; ?>" target="_blank">
                          <i class="fa-solid fa-file-invoice pick-sheet"></i>
                        </a>
                      <?php } ?>
                      <a title="Edit" class="btn-edit-sale" href="order/<?php echo $orderno; ?>">
                        <i class="fa-sharp fa-solid fa-pencil"></i>
                      </a>
                      <a title="Delete" class="btn-delete-sale delete" href="order/delete/<?php echo $id; ?>">
