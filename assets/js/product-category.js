$(document).ready(function () {
  ...
  $(".item-list-dataTable").on("click", ".btn-edit-sale", function (e) {
    ...
    $(".open-product-category-btn").trigger("click");
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $("#cat_name").val(response.data.cat_name);
        $("#cat_des ").val(response.data.cat_des);
        ...
        $("#status_cat").val(response.data.status_cat);
        $("#pro_cat_id").val(response.data.id);

        $("#savefrmBtn").text("Update");
        $(".slider-form-header").text("Update Product Category");
      },
  ...
  $(".slide-form-submit").on("submit", function (e) {
    ...
    if ($("#slide_new_form").valid()) {
      ...
      url = API_BASE_URL + "product-category/create";
      let pro_cat_id = $("#pro_cat_id").val();
      if (pro_cat_id) {
        url = API_BASE_URL + "product-category/update";
      }
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.status == true) {
            ...
            listDataTable.draw();
            location.reload();
          } else if (response.status == "cat_name") {
            let alertError = "";
            alertError +=
