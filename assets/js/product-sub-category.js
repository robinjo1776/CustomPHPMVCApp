$(document).ready(function () {
  ...
  $(".item-list-dataTable").on("click", ".btn-edit-sale", function (e) {
    ...
    $(".open-product-sub-category-btn").trigger("click");
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $("#scat_name").val(response.data.scat_name);
        $("#pcat_id").val(response.data.pcat_id);
        $("#scat_des").val(response.data.scat_des);
        ...
        $("#status_scat").val(response.data.status_scat);
        $("#scat_id").val(response.data.id);

        $("#savefrmBtn").text("Update");
        $(".slider-form-header").text("Update Sub Category");
      },
  ...
  $(".slide-form-submit").on("submit", function (e) {
    ...
    if ($("#slide_new_form").valid()) {
      ...
      url = API_BASE_URL + "product-sub-category/create";
      let scat_id = $("#scat_id").val();
      if (scat_id) {
        url = API_BASE_URL + "product-sub-category/update";
      }
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (response.status == true) {
            ...
            listDataTable.draw();
            location.reload();
          } else if (response.status == "scat_name") {
            let alertError = "";
            alertError +=
